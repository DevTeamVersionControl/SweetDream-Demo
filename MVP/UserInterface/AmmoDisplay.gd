...
#	$TextureRect.texture = ammo[ammo_index]
	match(ammo_index):
		0:
			$RichTextLabel.text="Candy corn"
		1:
			$RichTextLabel.text="Jelly bean"
		2:
			$RichTextLabel.text="Popping candy"
		3:
			$RichTextLabel.text="Jawbreaker"
		4:
			$RichTextLabel.text="Jello"
		5:
			$RichTextLabel.text="Icing gun"
